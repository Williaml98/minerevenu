...
export default function Navbar({ onSearch }: NavbarProps) {
    ...
    const getInitials = () => {
        if (!userDetails?.username) return "OF";
            ...
            <div className="flex items-center justify-between px-5 py-3 gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="profile-trigger flex items-center justify-center w-10 h-10 rounded-full overflow-hidden cursor-pointer transition-all hover:ring-2 hover:ring-emerald-500/40"
                        style={{ background: "linear-gradient(135deg,#064e3b,#059669)", border: "1.5px solid rgba(255,255,255,0.12)" }}
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <div
                                ...
                                style={{ background: "linear-gradient(135deg,rgba(5,150,105,0.15),rgba(14,165,233,0.12))", borderBottom: "1px solid var(--card-border)" }}
                            >
                                <div className="flex items-center justify-center w-12 h-12 rounded-2xl overflow-hidden flex-shrink-0" style={{ background: "linear-gradient(135deg,#064e3b,#059669)" }}>
                                    {userDetails.profile_picture ? (
                                ...
                                <div className="min-w-0">
                                    ...
                                    <span className="inline-block mt-1 text-[10px] font-semibold px-2 py-0.5 rounded-full uppercase tracking-wide" style={{ background: "rgba(5,150,105,0.15)", color: "#34d399" }}>
                                        {userDetails.role}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="p-2">
                                <Link href="/officer/settings" onClick={() => setShowDropdown(false)}
